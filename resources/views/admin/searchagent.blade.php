            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <div class="card">
                        ...
                        @if(Session::has('agent_deleted'))
                            <div class="alert alert-success">
                                {{Session::get('agent_deleted')}}
                            </div>
                        @endif
                        <div class="card-body">
                            <form type="get" action="{{route('agent.search')}}">
                                ...
                                <tbody class="text-center">
                                        @foreach($agent as $agent)
                                            <tr>
                                                <td>{{$agent->name}}</td>
                                                <td>
                                                    <a href="/admin/agent/update/{{$agent->id}}" class="btn btn-success">View</a>
                                                    <a href="/admin/agent/delete/{{$agent->id}}" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                </tbody>
                    ...
                    <a href="/admin/addagent" class="btn btn-success" style="margin-top:20px">Add Agent</a>
                </div>
            </div>
        </div>
    </section>
