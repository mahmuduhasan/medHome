        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                                ...
                                <tbody class="text-center">
                                        @foreach($offer as $offer)
                                            <tr>
                                                ...
                                                <td>{{$offer->coufon}}</td>
                                                <td>
                                                    <a href="/admin/delete/offer/{{$offer->id}}" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                </tbody>
                    ...
                    <a href="/admin/addoffer" class="btn btn-success" style="margin-top:20px">Add Offer</a>
                </div>
            </div>
        </div>
    </section>
