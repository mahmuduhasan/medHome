                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('agent.update')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$agent->name}}" class="form-control" name="name" id="name"/>
                                </div>
                                
                                <div class="form-group">
                                    <label for="address">Address</label>
                                    <textarea name="address" class="form-control" id="address" rows="1">{{$agent->address}}</textarea>
                                </div>
